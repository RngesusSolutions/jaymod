...
//		S_FLAG_DROPPED - The flag is dropped somewhere on the map.
//		S_FLAG_CARRIED - The flag is being carried.
...
//		GAME_STATE_INVALID - An invalid game state. Usually a startup condition.
//		GAME_STATE_LOADING - Game is in a loading phase.
//		GAME_STATE_WARMUP - Game is in a warmup/training phase.
//		GAME_STATE_PLAYING - Game is in an active playing state.
//		GAME_STATE_INTERMISSION - Game is in an intermission.
//		GAME_STATE_SCOREBOARD - Game is showing a score board.
...
// enumerations: GameModes
//		GMODE_INVALID - Invalid game mode.
//		GMODE_NORMAL - Standard game mode (not deathmatch or teamplay typically).
//		GMODE_DEATHMATCH - Deathmatch game mode.
//		GMODE_TEAM - Team play game mode.
//		GMODE_CTF - Capture the flag.
//		GMODE_EXECMODE - Exec/Bomb game mode.
